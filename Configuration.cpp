...
namespace neztu
{
    ...
    {
        // First we insert empty settings into the map.  This way we can ensure
        // that they exist in the map even if they are not in the config file,
        // and then we can use the map as a reference for valid settings when
